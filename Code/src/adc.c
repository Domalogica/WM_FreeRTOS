...
{ 
  ADC1->SQR3 = ADC_SQR3_SQ2;                   //загрузить номер канала
...
void ADC_Init(void)
{
	...
	GPIO_SetPinMode (GPIOA, GPIO_PIN_5, GPIO_MODE_ANALOG);					//ADC channel analog mode
	GPIO_SetPinMode (GPIOA, GPIO_PIN_6, GPIO_MODE_ANALOG);					//ADC channel analog mode
	GPIO_SetPinMode (GPIOA, GPIO_PIN_7, GPIO_MODE_ANALOG);					//ADC channel analog mode
...
/**
  ...
  *     @arg ADC_Channel_15: ADC Channel1 5   selected
